...
class ActionsComments implements Check
{
    ...
    private static function checkActions($tokens, $fullNamespace, PhpFileDescriptor $file)
    {
    ...
    public static function getCallsiteInfo($methods, $route)
    {
        ...
        $relativePath = PhpFileDescriptor::make($absPath)->relativePath()->getWithUnixDirectorySeprator();
