...
trait CommandsRegistry
{
    private static $commandNames = [
        ...
        Features\CheckGates\CheckGatesCommand::class,
        Features\CheckRoutes\CheckRoutesCommand::class,
        ...
        Features\SearchReplace\Commands\CheckExtraSemiColonsCommand::class,
        Features\SearchReplace\Commands\EnforceArrowFunctions::class,
        Features\SearchReplace\Commands\AnonymizeMigrationsCommand::class,
