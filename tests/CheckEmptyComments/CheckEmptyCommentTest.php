...
use Imanghafoori\LaravelMicroscope\Commands\CheckEmptyComments;
...
class CheckEmptyCommentTest extends TestCase
{
    public function setUp(): void
    {
        ...
        mkdir(__DIR__.'/app');
        copy(__DIR__.'/empty_comment-init.stub', __DIR__.'/app/EmptyComment.php');
    ...
    public function tearDown(): void
    {
        ...
        unlink(__DIR__.'/app/EmptyComment.php');
        rmdir(__DIR__.'/app');
    ...
    public function extra_dynamic_where_get_refactored()
    {
        ...
        $actual = file_get_contents(__DIR__.'/app/EmptyComment.php');
        $expected = file_get_contents(__DIR__.'/empty_comment-final.stub');
